...
public class HermesGatewayService extends Service {
    ...
    public static final String ACTION_START = "com.hermux.GATEWAY_START";
    public static final String ACTION_STOP = "com.hermux.GATEWAY_STOP";
    public static final String ACTION_CHECK = "com.hermux.GATEWAY_CHECK";
    public static final String ACTION_RESTART = "com.hermux.GATEWAY_RESTART";
